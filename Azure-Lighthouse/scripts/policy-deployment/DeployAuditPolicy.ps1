...
foreach ($ManagedSub in $ManagedSubscriptions)
{
    ...
    $policytemplateURI = 'https://raw.githubusercontent.com/paulfcollins/public-azure/master/Azure-Lighthouse/policy-template-samples/audithttpstraffic-onlystorageaccount.json' 
